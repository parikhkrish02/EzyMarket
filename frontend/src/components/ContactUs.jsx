                    ...
                    <div className="flex flex-wrap">
                        <div className="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
                            <form>
                                ...
                                <button type="submit" className=" w-full px-6 py-2.5 bg-[#60b192] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-[#1b815b] hover:shadow-lg focus:bg-[#1b815b] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#1b815b] active:shadow-lg transition duration-150 ease-in-out">Send</button>
                            </form>
                        </div>
